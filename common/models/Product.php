...
class Product extends \yii\db\ActiveRecord
{
    ...
    private static $_shopName = [
        self::SVET_SHOP => 'Світлоград',
        self::EGLO_SHOP => 'ЕГЛО',
        self::FREYA_SHOP => 'Freya',
        self::MAYTONI_SHOP => 'Maytoni',
        self::ARTGLASS_SHOP => 'ARTGLASS',
        self::UNIVERSAL_SHOP => 'Universal',
    ];

    private static $_categoryName = [
        self::CATEGORY_OTHER => 'Інше',
        self::CATEGORY_LUSTER => 'Люстри',
        self::CATEGORY_WALL_LAMP => 'Бра і настінні світильники',
        self::CATEGORY_TABLE_LAMP => 'Настільні лампи',
        self::CATEGORY_MOUNT_LAMP => 'Підвіси',
        self::CATEGORY_FLOOR_LAMP => 'Торшери',
        self::CATEGORY_SPOOT_LIGHT => 'Точечні світильники',
    ];
...
//        '18' => 'Сталь, бетон',
//        '19' => 'Сталь, пластик',
//        '20' => 'Скло з ефектом потертості',
//        '21' => 'Бетон, дерево',
//        '22' => 'Тканина льон, пластик',
...
//        '32' => 'Сталь, кришталь',
//        '33' => 'Скло, алюміній',
//        '34' => 'Скло, сталь, кришталь',
//        '35' => 'Сталь, алюміній, кришталь',
//        '36' => 'Матове скло, дзеркало',
//        '37' => 'Сталь, пластик, кришталь',
//        '38' => 'Тканина, фольга, пластик',
//        '39' => 'Алюміній, сталь',
//        '40' => 'Тканина, пластик',
//        '41' => 'Тканина, пластик, скло',
//        '42' => 'полірезина',
//        '43' => 'Метал',
//        '44' => 'Дерево, метал',
//        '45' => 'Металі, кераміка',
...
//    ];
    ...
    {
        return ArrayHelper::map(Material::find()->all(),'id','name');
    }

    public static function materialName($material_id)
    {
        return self::materialsNamesList()[$material_id];
    }
